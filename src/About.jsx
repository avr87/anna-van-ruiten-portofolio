      ...
      <div className="container-about">
        <div className="about">
          ...
          <p>
            Hey there! 👋🏽
            <br />
            My name is Anna, and I'm a Junior Software Developer passionate
            about coding and theatre 🎭. I started my coding journey with
            <a
            ...
            daughter and show her that anything is achievable with resilience
            and determination 💪.
            <br />
            <br />
